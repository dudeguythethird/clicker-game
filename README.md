...
![Image showing project across various devices](/assets/images/ms2-responsive.png)
 
This [project](https://dudeguythethird.github.io/stuff-getter/) is a simple clicker/ incremental game (in the style of *Cookie Clicker* or *Tap Tycoon*). Its main aim is to provide a fun experience of interactive growth for the player. It must achieve this with only HTML, CSS, and Javascript (JQuery). 
...
1. A page footer that includes generic copyright information, as well as links to my (coding relevant) social media pages. These will help anyone who wants to get in touch with me, in a professional context, do so with ease. 
...
I have recorded videos of myself testing the project across all the major browsers, available on Windows, [here](https://drive.google.com/drive/folders/1r7CLiZb6ucip8Xx9JeeDGuRnenri0thK?usp=sharing). The videos have the same earlier layout as the screenshots above, again though, the functionality they show has not changed.
